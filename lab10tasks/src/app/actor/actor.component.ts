...
export class ActorComponent implements OnInit {
  ...
  //extra
  onAddMovieToActor() {
    this.dbService.addMovieToActor(this.mId, this.actorId).subscribe((data: any) => {
      this.onGetActors();
    })
  }

  onGetMovieActorCount() {
    this.dbService.getMovieActorCount(this.actorId).subscribe((data: any) => {
      this.onGetActors();
    })
  }
}
