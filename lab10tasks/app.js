...
app.use("/", express.static(path.join(__dirname, "dist/lab10tasks")));
...
app.post('/actor/:actorId/movie/:mId', actors.addMovie);
...
app.get('/actors/movies/:id', actors.getActorMovieCount);